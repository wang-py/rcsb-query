...
def download_pdb(pdb_identifier):
    pdb_filename = pdb_identifier + ".pdb"
    url = (
            "https://files.rcsb.org/download/" + pdb_filename
            )
    urlretrieve(url, pdb_filename)


q1 = TextQuery("Respiratory Complex I")
q2 = AttributeQuery("rcsb_polymer_entity" +
